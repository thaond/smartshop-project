...
//	}
	...
	private void browseTo(final File aDirectory){
		...
		if (aDirectory.isDirectory()){
			...
			AlertDialog ad = new AlertDialog.Builder(this).setPositiveButton(
					"OK", okButtonListener).setTitle("Question").setMessage(
					"Do you want to open that file?n").setNegativeButton(
					"Cancel", cancelButtonListener).create();
			ad.show();
		}
	}
