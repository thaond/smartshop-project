...
public class ViewRelatedProductsActivity extends ListActivity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		list = getListView();
		adapter = new ProductAdapter(this, R.layout.product_list_item, new FacebookUtils(this));
	...
	private void loadProducts(final long productId) {
		task = new SimpleAsyncTask(this, new DataLoader() {
			...
			public void updateUI() {
				if (products.size() == 0) {
					...
					adapter = new ProductAdapter(
							ViewRelatedProductsActivity.this,
							R.layout.product_list_item, products,
							new FacebookUtils(ViewRelatedProductsActivity.this));
			...
			public void loadData() {
				String url = String.format(URLConstant.GET_RELATED_PRODUCTS,
						productId);
