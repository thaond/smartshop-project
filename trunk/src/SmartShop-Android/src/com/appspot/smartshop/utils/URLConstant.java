...
public class URLConstant {
	...
	public static String CREATE_PAGE = String.format(HOST
			+ "/api/asd/create-page/?session=%s", Global.getSession());
	public static String EDIT_PAGE = String.format(HOST
			+ "/api/asd/page-edit/?session=%s", Global.getSession());
	...
	public static String ADD_NEW_COMMENT = String.format(HOST
			+ "/api/asd/create-comment/?session=%s", Global.getSession());
	...
	public static String CREATE_SUBCRIBE = String.format(HOST
			+ "/api/asd/create-subcribe/?session=%s", Global.getSession());
